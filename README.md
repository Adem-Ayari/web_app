...
A minimal, animated product showcase built as a hands-on exercise in React state management and CSS animation. The live version is at [web-app-85en.vercel.app](https://web-app-85en.vercel.app/).
